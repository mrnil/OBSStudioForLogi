namespace Loupedeck.OBSStudioForLogiPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.OBSStudioForLogiPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.OBSStudioForLogiPlugin.Resources.Resource.txt`.
